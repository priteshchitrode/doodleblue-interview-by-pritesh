...
extension WidgetExtension on Widget? {
  ...
  Padding bottomNavigationPadding() {
    return Padding(padding: const EdgeInsets.only(bottom: 40, right: safeAreaPadding, left: safeAreaPadding, top: 5), child: this);
  }

  /// Bottom Navigation padding all
  Padding bottomButtonPadding() {
    return Padding(padding: const EdgeInsets.only(bottom: 25), child: this);
  }
  ...
  /// Blur
  Widget backgroundBlur({double? blur}) {
    return ClipRRect(
