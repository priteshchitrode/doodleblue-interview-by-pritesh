...
class AppColors {
  AppColors._();
  static const Color primaryColor = Color(0xff292D32);
  ...
  static const Color textFieldFillColor = Color(0xffF2F2F3);
  ...
  static const Color lightPrimaryColor = Color(0xffCAC2ED);
  ...
  static final Color shimmerBaseColor = Colors.grey.shade200;
  ...
  static List<Color> buttonGradientColor = [const Color(0xff917AFD), primaryColor, const Color(0xff6246EA)];
}
